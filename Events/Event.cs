...
namespace iParking.Events
{
    ...
    public delegate void SetZoneStatusByHandHandler(object sender, SetZoneStatusByHandEventArgs e);
    public delegate void ReleaseOrderEventHandler(object sender, ReleaseOrderEventArgs e);


    public class ReleaseOrderEventArgs: EventArgs
    {
        public string ZoneID { get; set; }
    }

    public class SetZoneStatusByHandEventArgs
    {
        public string ZoneID { get; set; }
        public EM_ZoneStatusType  Status { get; set; }
        public bool isUseAI { get; set; }
    }
